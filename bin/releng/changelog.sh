...
Build [#$TRAVIS_BUILD_NUMBER](https://app.travis-ci.com/github/$TRAVIS_REPO_SLUG/builds/$TRAVIS_BUILD_ID) finished at $date
Release tarball built from [#$TRAVIS_JOB_NUMBER](https://app.travis-ci.com/github/$TRAVIS_REPO_SLUG/jobs/$TRAVIS_JOB_ID)

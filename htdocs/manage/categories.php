...
if (@$_POST["cat"] == "new") {
    ...
    Misc::mapMessages($res, array(
            1   =>  array('Thank you, the category was added successfully.', Misc::MSG_INFO),
            -1  =>  array('An error occurred while trying to add the category.', Misc::MSG_ERROR),
            -2  =>  array('Please enter the title for this new category.', Misc::MSG_ERROR),
    ));

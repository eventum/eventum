...
// make backup copy
$backup_file = APP_PATH . "/config.inc.pre_1_5_4.php";
...
$config_contents = str_replace("%{APP_VERSION}%", "1.5.4", $config_contents);
...
?>
Done. Your configuration file (config.inc.php) has been upgraded to version 1.5.4.<br />

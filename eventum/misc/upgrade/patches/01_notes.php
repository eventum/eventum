...
function db_patch_1() {
	$stmts = array();
	$stmts[] = "ALTER TABLE %TABLE_PREFIX%note CHANGE COLUMN not_blocked_message not_blocked_message longblob NULL";
	...
	$stmts[] = "ALTER TABLE %TABLE_PREFIX%note CHANGE COLUMN not_blocked_message not_full_message longblob NOT NULL";

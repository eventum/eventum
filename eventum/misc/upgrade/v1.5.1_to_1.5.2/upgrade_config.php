...
// make backup copy
$backup_file = APP_PATH . "config.inc.php_pre_1_5_1_2";
...
$config_contents = str_replace("%{APP_VERSION}%", "1.5.2", $config_contents);
...
fclose($fp);
?>
Done. Your configuration file (config.inc.php) has been upgraded to version 1.5.2. <br />

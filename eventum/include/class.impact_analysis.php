        ...
        if (PEAR::isError($res)) {
            ...
            if (count($res) == 0) {
                ...
                for ($i = 0; $i < count($res); $i++) {
                    $res[$i]["isr_requirement"] = Misc::activateIssueLinks(nl2br(htmlspecialchars($res[$i]["isr_requirement"])));
                    $res[$i]["isr_impact_analysis"] = Misc::activateIssueLinks(nl2br(htmlspecialchars($res[$i]["isr_impact_analysis"])));

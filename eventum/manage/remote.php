...
// +----------------------------------------------------------------------+
//
// @(#) $Id: s.remote.php 1.5 03/03/01 23:27:37-00:00 jpm $
//
...
if (($role_id == User::getRoleID('administrator')) || ($role_id == User::getRoleID('manager'))) {
    ...
    if (@$HTTP_POST_VARS["cat"] == "update") {
        Project::updateRemoteInvocation($prj_id);
    }
    ...
    $tpl->assign("options", Project::getRemoteInvocationOptions($prj_id));

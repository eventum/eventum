...
function getEmail($id)
{
    ...
    if (!empty($_GET["ec_id"])) {
        return Link_Filter::processText(Auth::getCurrentProject(), nl2br(Misc::activateLinks(htmlspecialchars($_GET["ec_id"] . ":" . $id. ":" . $info["message"]))));
    } else {
...
function getNote($id)
{
    ...
    if (!empty($_GET["ec_id"])) {
        return Link_Filter::processText(Auth::getCurrentProject(), nl2br(Misc::activateLinks(htmlspecialchars($_GET["ec_id"] . ":" . $id. ":" . $note["not_note"]))));
    } else {
...
function getDraft($id)
{
    ...
    if (!empty($_GET["ec_id"])) {
        return Link_Filter::processText(Auth::getCurrentProject(), nl2br(Misc::activateLinks(htmlspecialchars($_GET["ec_id"] . ":" . $id. ":" . $info["emd_body"]))));
    } else {
...
function getPhoneSupport($id)
{
    ...
    if (!empty($_GET["ec_id"])) {
        return Link_Filter::processText(Auth::getCurrentProject(), nl2br(Misc::activateLinks(htmlspecialchars($_GET["ec_id"] . ":" . $id. ":" . $res["phs_description"]))));
    } else {
...
function getMailQueue($id)
{
    ...
    if (!empty($_GET["ec_id"])) {
        return Link_Filter::processText(Auth::getCurrentProject(), nl2br(Misc::activateLinks(htmlspecialchars($_GET["ec_id"] . ":" . $id. ":" . $res["maq_headers"] . "\n" . $res["maq_body"]))));
    } else {
        return $res["maq_body"];
    }
}
